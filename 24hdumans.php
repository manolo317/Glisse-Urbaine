...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
	<head>
		<title>Historique des 24 heures du Mans Roller</title>
	...
	<?php include("menu.php"); ?>
		...
		<div id="conteneur">
			<h2 class="titrePrincipalRoller">Immersion dans les 24 heures du Mans Roller</h2>
			...
			<div id="introller">
				...
				<p>
					...
					L'organisation a su s'adapter à cette expansion, et a proposé un évènement regroupant tous les amoureux de roulettes.</br>
					Parce qu'avant tout ca reste une compétition, très disputée (même si c'est toujours Powerslide qui gagne à la fin!), où s'affronte les meilleurs coureurs de la planète, mais aussi le rouleur du dimanche, c'est ce qui fait tout le charme de cette course.</br>
					Le cadre aussi est magnifique, avec le circuit Bugatti, et la célèbre montée Dunlop qui casse les pattes, long de 4,185kmn il offre un cadre parfait pour se dépasser.
				</p>
			...
			<div id="corps">
				<ul>
					<li>
						<div class="para_article">
							<h3>Journal de bord 2013:</h3>
					
							<p>
								Cette année c'est la 3ème participation du To(R)ride Crew, notre équipe, composée d'une bande d'amis de 20 à 30 ans, assez représentative des équipes amateurs engagées aux 24h.
								Nous avons deux équipes pour cette dernière édition, le To(R)ride Classic, où l'objectif est de rouler et profiter des copains sans se prendre la tête avec les chronos, et la deuxième équipe, le To(R)ride Warrior, où nous sommes que 6, bien décidés à se faire mal...
							</p>
						</div>
					</li>
					<li>	
					...
					<li>	
						<div class="para_article">	
							...
							<p>	
								Nous allons déposer nos patins de l'autre bout de la piste et nous nous plaçons de l'autre côté, on se rend compte qu'il y a beaucoup de concurrents (et deux fois plus de patins...), excitation monte...
								Je n'entends pas le départ, mais je me réveille en voyant tout le monde courir vers ses patins, ça joue des coudes, la mise des patins est interminable, un petit geste pour Chloé qui prend son temps et c'est parti à bloc!
							</p>
						
							<p>
								Avec l'adrénaline et la fraicheur, le premier tour est toujours excellent d'un point de vue chronométrique, mais aussi du point de vue des sensations, j'avale les concurrents dans la montée Dunlop, et je me dis que je la voyais plus dure que ça il y a deux ans... Au bout du deuxième tour, je me dis que j'ai démarré fort, peut être trop fort, cette année nous avons décidé de faire des relais de 5 à 6 tours sur une heure, mais à partir du 4 ème tour je trouve mon rythme.
								Après un tout petit peu plus d'une heure de course, et 6 tours, c'est l'heure de passer le relais à Elen, je suis déjà bien rincé et content d'en avoir fini, rendez-vous dans 5 heures.
							</p>
		
							<p>
								Retour au stand où je fais part de mes impressions et des premières anecdotes de course, la course n'a pas encore démarrée pour tout le monde, ça discute stratégie de relais et ça s'inquiète de la pluie qui se fait menaçante.
								L'attente entre les relais est un peu longue, je suis encore sur l'excitation du départ, je vais encourager les copains au bord de la piste, prochain relais à 22h.
							</p>
						</div>
					</li>
					<li>	
						<div class="para_article">	
							...
							<p>
								La nuit rajoute un aspect encore plus magique à la course, l'ambiance change sur la piste et dans les stands, oùc ertains essayent de dormir malgré la sono à fond qui nous passe les plus grands succès de Fun radio des années 2000.</br>
								Après mon 4ème repas (ou encas) de la journée, et une session mots-fléchés éprouvante, je m'accorde une mini-nuit de minuit à 3 heures. Je me lève une heure avant mon prochain relais, histoire de me remettre en route, le réveil et brutal. En effet, la température a chutée brusquement pour atteindre 0°C, malgré mon pull et mon manteau, je claque des dents, l'ambiance est bien retombée, il n'y a que les deux relayeurs de l'équipe Classic debout sur notre stand, les autres sont tous couchés ou sur la piste. 
							</p>
						</div>
					</li>
					<li>	
					...
					<li>	
						<div class="para_article">	
							...
							<p>
								A peine terminer, pas le temps de se congratuler, c'est la course pour démonter et ranger le stand, chacun repart aux quatre coins de la France (et même la Suisse!), nous allons récupèrer notre médaille et rendre nos puces, puis les aurevoirs précipités avec les membres de la Team.
								On me dépose à la gare du Mans, où je m'échoue sur un banc, lessivé, je m'endors en attendant mon train pour Paris.
							</p>
						</div>
					</li>
					<li>	
				...
				<div class="like">
				<div class="fb-like" data-href="https://www.glisseurbaine.fr/24hdumans.php" data-send="true" data-width="450" data-show-faces="true"></div>      
