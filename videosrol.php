...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
	<head>	
		<title>Toutes les vidéos Roller</title>
	...
	<div id="conteneur">
		<div id="corps"> 
			<h3 class="titreSecondRoller">Vidéos Roller</h3>
			<img src="photos/adrien-anne.jpg" alt="adrien anne" title="adrien anne photo de michael garijo" class="photovideo"/>
			<br/>
			<div class="lien-page">
				<span>
					(1)
					<a href="videosrol-page2.php" title="page 2">2</a>
					<a href="videosrol-page2.php" title="page suivante">></a>
				</span>
			</div>
			<ul>
				<div id="lignemenu"></div>
				<li class="video">
					<a href="video-cudot-trigger.php" title="voir la vidéo"><img src="photos/videoroller.jpg" alt="logo video roller" class="photoarticle"/><br/><br/><div class="imagehover"><iframe  class="minivideo" width="154" height="80" src="https://www.youtube.com/embed/HgZjYtnu4lM" frameborder="0" allowfullscreen></iframe><img src="photos/fond-noir-video.jpg" class="roll2" /><span> <strong>Julien Cudot</strong> présente sa nouvelle marque: Trigger Skates</span></div></a>
				</li>
				<div id="lignemenu"></div>
				<li class="video">
			...
			<br/>
			<div class="fb-like" data-href="https://www.glisseurbaine.fr/videos.html" data-send="true" data-width="450" data-show-faces="true"></div>      <a href="http://twitter.com/share" class="twitter-share-button"
