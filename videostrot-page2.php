...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
	<head>
		<title>Toutes les vidéos Trottinette</title>
	...
	<div id="conteneur">	
		<div id="corps"> 
			...
			<img src="photos/photovideotrot.png" alt="trotirider" class="photovideo"/>
			<br/>
			<div class="lien-page">
				<span>
					<a href="videostrot.php" title="page 1">1</a>
					(2)
					<a href="videostrot.php" title="page précédente"><</a>
				</span>
			</div>
			<ul>
				<li class="video">
					<a href="video-lucky.php" title="voir la vidéo"><img src="photos/videotrottinette.jpg" alt="logo video trottinette" class="photoarticle"/><br/><br/><div class="imagehover"><iframe class="minivideo" width="154" height="80" src="https://www.youtube.com/embed/K6jEzM-I6FA?feature=player_detailpage" frameborder="0" allowfullscreen></iframe><img src="photos/fond-noir-video.jpg" class="roll2" /><span> Vidéo de la Team Lucky Scooter</span></div></a>
				</li>
			...
			<br/>
			<div class="fb-like" data-href="https://www.glisseurbaine.fr/videostrot.php" data-send="true" data-width="450" data-show-faces="true"></div>      <a href="http://twitter.com/share" class="twitter-share-button"
