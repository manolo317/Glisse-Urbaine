...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
	<head>
		<title>Quel avenir pour la trottinette freestyle?</title>
					...
					<li>
						<div class="para_article">
							...
							<p>
								...
								Quelques soient les motivations des acteurs, cela a permis à la trottinette de se développer, une émulation qui a fait évoluer le matériel et la pratique techniquement, mais aussi l'image de la trottinette freestyle.</br></p></br>
								<p>Aujourd'hui, il existe plus d'une cinquantaine de marques spécialisées, couvrant toutes les gammes de prix, le marché arrive à saturation et commence clairement à stagner, l'effet de mode s'en est allé.
								Il est évident qu'il va y avoir un sérieux écrémage dans les années à venir, avec en premières lignes les grosses marques commerciales qui ont profité du marché et qui se désintéresseront de la trottinette dès qu'elle ne sera plus <strong>"bankable"</strong>.</br> Mais les petites marques <strong>"Core"</strong> risquent aussi de souffrir, quand les petits de Neuilly ce seront lassés de changer de deck toutes les deux semaines.</br>
								Autres limites du marché, ce sont les prix du matériel, il faut bien compter 300 à 400 euros pour une trottinette correcte, et la durée de vie des pièces reste très faible (6 mois maximum pour un deck, et encore moins pour un jeu de direction, un frein, une roue ou des roulements) même avec les gros progrès techniques et l'utilisation de nouveaux alliages de métaux plus solides. Au final, le budget d'un trottirider avoisine le millier d'euro par an, un budget bien moins abordable que le skateboard ou le roller par exemple.
							</p>
						</div>
					</li>
					<li>
						<div class="para_article">
							...
							<p>
								...
								<strong>Ryan Williams</strong> cartonne avec le <a href="http://nitrocircus.com/fr/riders/ryan-williams/" title="Ryan Williams au Nitro Circus"><strong>Nitro Circus</strong></a>, fait découvrir au grand public la trottinette freestyle, et se paye même le luxe, à grand coup de <strong>World First</strong>, de forcer le respect de toute la planète glisse.</br> Cette année, la trottinette freestyle est en démonstration au <a href="http://www.fise.fr/fr" title="vers le site du FISE"><strong>FISE</strong></a> de Montpellier, de quoi tester sa popularité avant de voir plus haut avec les X-Games.
								Dernière variable, l'âge des pratiquants, qui se situe entre 12 et 20 ans, on peut se demander s'ils vont continuer de pratiquer la trottinette à 25 ou 30 ans.
							</p>
						</div>
					</li>
					<li>
						<div class="para_article">
							...
							<p>
								La pratique de la trottinette freestyle est en train de s'installer avec un noyau dur de riders et de marques <strong>"Core"</strong>, elle s'est même structurée avec la création d'une fédération, l'<strong>ISA</strong> et d'autres associations au niveau local, mais elle risque de souffrir ces prochaines années, une fois l'effet de mode disparu.<br/> Elle a encore besoin de prouver qu'elle est une vraie pratique freestyle et qu'elle peut attirer de nouveaux adeptes, sponsors et ainsi se pérenniser dans le temps.
							</p>
						</div>
					</li>
				</ul>
				</br>
				<iframe class="video-large" width="640" height="360" src="http://www.youtube.com/embed/DE7hoJaOi-Y?feature=player_detailpage" frameborder="0" allowfullscreen></iframe>
				<div class="like">
				<div class="fb-like" data-href="https://www.glisseurbaine.fr/avenirtrot.php" data-send="true" data-width="450" data-show-faces="true"></div>      <a href="http://twitter.com/share" class="twitter-share-button"
