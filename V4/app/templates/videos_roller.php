...
<div id="corps">
    ...
    <img src="<?= BASE_URL ?>/public/img/adrien-anne.jpg" alt="adrien anne" title="adrien anne photo de michael garijo" class="photovideo"/>
    <br/>
    <div class="lien-page">
        <!-- Pagination -->
        <span>
